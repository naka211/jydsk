...
<?php endif;?>
		...
		<table class="table table-striped" id="profileList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PROFILES_PROFILES_RANK', 'a.rank', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PROFILES_PROFILES_EMAIL', 'a.email', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PROFILES_PROFILES_TELEPHONE', 'a.telephone', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PROFILES_PROFILES_DESCRIPTION', 'a.description', $listDirn, $listOrder); ?>
				</th>
